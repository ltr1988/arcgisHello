...
import com.jiangyonghao.recycleview.nanshuibeidiao.activity.ShowAllPhoto;
...
/**
 * Created by jiangyonghao on 2016/8/18.
 */
...
//			holder.imageView.setImageBitmap( AlbumActivity.contentList.get(position).imageList.get(0).getBitmap());
            ...
            cache.display(holder.imageView,item.imagePath);
        }
        // 为封面添加监听
