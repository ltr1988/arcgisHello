...
package com.jiangyonghao.recycleview.nanshuibeidiao.database;
...
public abstract class SCardDatabase {

    private static final String TAG = SCardDatabase.class.getSimpleName();
    ...
    public SCardDatabase(Context context, String path, String name,
    ...
    public File getDatabasePath(String dbpath, String dbName) {
        ...
        File path = new File(dbpath);// 创建目录
