...
-(NSArray *)defaultUIStyleMapping
{
    ...
    return @[
             ...
             @{
                 @"group":@"右",
                 @"right_temperatureinh":@[@(SheetUIStyle_Switch),@(1)],
                 ...
                 @"right_temperatureinl":@[@(SheetUIStyle_Switch),@(6)],
                 },
             @{
                 @"group":@"左",
                 @"left_temperatureinh":@[@(SheetUIStyle_Switch),@(1)],
                 ...
                 @"left_temperatureinl":@[@(SheetUIStyle_Switch),@(6)],
                 },
             @{
                 @"group":@"xx",
                 @"temperaturein":@[@(SheetUIStyle_Switch),@(1)],
                 @"temperatureout":@[@(SheetUIStyle_Switch),@(2)],
