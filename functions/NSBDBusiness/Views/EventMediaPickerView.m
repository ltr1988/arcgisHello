...
-(instancetype) initWithFrame:(CGRect)frame readOnly:(BOOL)readOnly  picCallback:(ActionCallback)picCallback videoCallback:(ActionCallback)videoCallback  relayoutCallback:(ActionCallback)relayoutCallback{
...
-(void)setupSubviews
{
    ...
    picContentView.readonly = _readOnly;
...
-(void) adjustFrame
{
    ...
    {
        frame.size.height = picContentView.frame.size.height;
    }
