...
#define NormalColor UIColorFromRBG(204,230,255,1)
#define SelectColor UIColorFromRBG(89,134,191,1)

#define CenetrSwitchWidth 170
#define CenetrSwitchHeight 27

#define Key_Notification_ScrollValueChanged  @"k_ScrollValueChanged"
